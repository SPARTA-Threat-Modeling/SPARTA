...
/**
 * This is the item provider adapter for a {@link be.kuleuven.cs.distrinet.sparta.spartamodel.ThreatPattern} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ThreatPatternItemProvider extends ModelElementItemProvider {
	/**
	 ...
	 * @generated
	 */
	public ThreatPatternItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ThreatPattern_longDescription_feature"),
	...
	protected void addPatternsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ThreatPattern_patterns_feature"),
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SpartaModelPackage.Literals.THREAT_PATTERN__MAPPING);
		}
	...
	/**
	 * This returns ThreatPattern.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ThreatPattern"));
	}
	...
	public String getText(Object object) {
		String label = ((ThreatPattern)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_ThreatPattern_type") :
			getString("_UI_ThreatPattern_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ThreatPattern.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(SpartaModelPackage.Literals.THREAT_PATTERN__MAPPING,
				 SpartaModelFactory.eINSTANCE.create(SpartaModelPackage.Literals.ESTRING_TO_ESTRING_MAP)));
	}
