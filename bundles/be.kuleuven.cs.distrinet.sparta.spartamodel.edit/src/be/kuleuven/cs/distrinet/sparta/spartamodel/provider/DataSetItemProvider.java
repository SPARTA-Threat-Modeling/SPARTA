...
/**
 * This is the item provider adapter for a {@link be.kuleuven.cs.distrinet.sparta.spartamodel.DataSet} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
	...
	protected void addDatatypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DataSet_datatype_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DataSet_datatype_feature", "_UI_DataSet_type"),
				 SpartaModelPackage.Literals.DATA_SET__DATATYPE,
				 true,
				 false,
				 true,
				 null,
