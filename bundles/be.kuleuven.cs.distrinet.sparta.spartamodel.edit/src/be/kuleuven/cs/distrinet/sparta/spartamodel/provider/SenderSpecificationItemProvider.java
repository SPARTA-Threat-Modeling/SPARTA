...
/**
 * This is the item provider adapter for a {@link be.kuleuven.cs.distrinet.sparta.spartamodel.SenderSpecification} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SenderSpecificationItemProvider extends FlowElementItemProvider {
	/**
	 ...
	 * @generated
	 */
	public SenderSpecificationItemProvider(AdapterFactory adapterFactory) {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addSpecifiesSenderOfPropertyDescriptor(object);
		}
	...
	/**
	 * This adds a property descriptor for the Specifies Sender Of feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addSpecifiesSenderOfPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SenderSpecification_specifiesSenderOf_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SenderSpecification_specifiesSenderOf_feature", "_UI_SenderSpecification_type"),
				 SpartaModelPackage.Literals.SENDER_SPECIFICATION__SPECIFIES_SENDER_OF,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This returns SenderSpecification.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/SenderSpecification"));
	}
	...
	public String getText(Object object) {
		String label = ((SenderSpecification)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_SenderSpecification_type") :
			getString("_UI_SenderSpecification_type") + " " + label;
	}
